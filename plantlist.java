...
public class plantlist {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            String url = "http://openapi.nature.go.kr/openapi/service/rest/PlantService/plntIlstrSearch?serviceKey="+key+"&numOfRows=10&pageNo=1";
            ...
            for(int temp = 0; temp < nList.getLength(); temp++){
                ...
                System.out.println(getTagValue("familyKorNm", eElement));
